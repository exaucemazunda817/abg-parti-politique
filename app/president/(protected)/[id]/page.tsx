...
export default async function PresidentPropositionDetailPage({
  params,
}: {
  ...
  if (!submission || submission.targetRole !== "PRESIDENT") notFound();
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <Link href="/president" className="text-sm text-abg-blue hover:underline">
      ...
      <div className="mt-4 rounded-2xl border border-black/10 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 grid gap-2 text-sm sm:grid-cols-2">
          <Info label="Organisation" value={submission.organisation ?? "—"} />
          <Info label="Nom du contact" value={submission.nom ?? "—"} />
        ...
        <div className="mt-6">
          <SubmissionStatusActions
            apiBase="/api/president/submissions"
